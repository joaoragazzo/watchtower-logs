...
public record RegisterUserDTO(
    ...
    @NotBlank(message = AuthenticationErrorCodes.BLANK_NAME) 
    @Schema(example = "John") 
    String name,
    
    @NotBlank(message = AuthenticationErrorCodes.BLANK_SURNAME) 
    @Schema(example = "Doe") 
    String surname,
    
    @NotBlank(message = AuthenticationErrorCodes.BLANK_EMAIL) 
    @Email(message = "invalid_email") 
    @Schema(example = "john_doe@email.com") 
    String email,
    
    @NotBlank(message = AuthenticationErrorCodes.BLANK_PASSWORD) 
    @Size(min = 7, max = 30, message = "invalid_password_size") 
    @Schema(example = "str0ngp4ssw0rd") 
    String password,
    
    @NotNull(message = AuthenticationErrorCodes.BLANK_BIRTH_DATE) 
